...
def opendocx(file):
    ...
    document = etree.ElementTree.fromstring(xmlcontent)
    return document
...
def contenttypes():
    types = etree.ElementTree.fromstring(
...
def coreproperties(title, subject, creator, keywords, lastmodifiedby=None):
    ...
    for doctime in ['created', 'modified']:
        ...
        coreprops.append(etree.ElementTree.fromstring(elm_str))
    return coreprops
...
def appproperties():
    ...
    appprops = etree.ElementTree.fromstring(
...
def wordrelationships(relationshiplist):
    ...
    relationships = etree.ElementTree.fromstring(
...
def savedocx(document, coreprops, appprops, contenttypes, websettings,
    ...
    for tree in treesandfiles:
        ...
        treestring = etree.ElementTree.tostring(tree, pretty_print=True)
