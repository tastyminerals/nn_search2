...
As you've noticed, not all found `NNP` are named entities, most of those words are just plain nouns which were incorrectly tagged. Unfortunately NLTK's tagger makes mistakes even though it has a fairly good accuracy (no perfect taggers exist).
...
This was a small example of a possible use case. As you've seen, the results need some manual correction. This is simple, because you are free to edit and save any text.

Well, what if you also want to know what all these *guys* did and to whom? Use following search query: `NNP VB{3} NN{1}`.

![9](http://i.imgur.com/2fGB8mY.png)

Be patient, the bigger your text and the shorter your search query the more time it will be required to display the results.
